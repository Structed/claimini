...
Wetehr to tread build warnings as errors.
...
Invoke-Expression "& `"$CakePath`" `"build.cake`" $Arguments -warningsAsErrors=`"$WarningsAsErrors`" $ScriptArgs"
exit $LASTEXITCODE
